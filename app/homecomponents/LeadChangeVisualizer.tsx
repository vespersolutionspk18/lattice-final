...
const LeadChangeVisualizer: React.FC<LeadChangeProps> = ({ text = "Lead The Change" }) => {
    ...
    <div ref={containerRef} className="w-full overflow-hidden  py-10 lg:py-26 relative cursor-pointer">
      ...
      >
        <Link href="/contact" className="pointer-events-auto">
          <Button variant="default"  className='hover:cursor-pointer hover:text-white' style={{ backgroundColor: '#581c87' }}>GET IN TOUCH</Button>
        </Link>
      </div>
    </div>
  )
...
export default LeadChangeVisualizer
