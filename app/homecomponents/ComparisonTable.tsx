    ...
    <div className="p-5">
      <div className="p-5 rounded-4xl flex flex-col gap-16 tracking-tighter">
        ...
        <div className="bg-white rounded-3xl overflow-hidden border border-gray-200">
          {/* Table Header */}
          <div className="grid grid-cols-[2fr_1fr_1fr] bg-gray-50 border-b border-gray-200">
            <div className="p-8"></div>
            <div className="p-8 text-center border-l border-gray-200">
              <h3 className="text-2xl font-bold text-[#3b82f6] tracking-tight">Lattice</h3>
            </div>
            <div className="p-8 text-center border-l border-gray-200">
              <h3 className="text-2xl font-semibold text-gray-500 tracking-tight">Others</h3>
            </div>
          </div>
              ...
              >
                ...
                <div className="p-8 flex items-start gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <p className="text-lg text-gray-600 tracking-tight" style={{ fontFamily: 'var(--font-figtree)', fontWeight: 400 }}>
                      {feature.description}
                    </p>
                  </div>
                </div>
                ...
                <div className="p-8 flex items-center justify-center border-l border-gray-200 bg-[#3b82f6]/5">
                  {feature.lattice === true && (
                    <div className="w-10 h-10 rounded-full bg-highlighter-green flex items-center justify-center">
                      <Check className="w-6 h-6 text-white stroke-[3]" />
                    </div>
                  )}
                  {feature.lattice === "partial" && (
                    <span className="text-lg font-medium text-gray-600">Partial</span>
                  )}
                ...
                <div className="p-8 flex items-center justify-center border-l border-gray-200">
