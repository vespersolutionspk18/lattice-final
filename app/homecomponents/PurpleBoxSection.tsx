...
const PurpleBoxSection = () => {
  ...
  return (
    <div className="p-10">
      {/* White Section */}
      <div className="rounded-4xl p-12 bg-white">
        <div className="grid grid-cols-2 gap-[67px] items-center">
          ...
          <div className="flex flex-col gap-[19px]">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg text-gray-600" style={{ fontFamily: 'var(--font-figtree)', fontWeight: 500 }}>
            ...
            <p className="text-2xl text-gray-600 leading-relaxed tracking-tighter" style={{ fontFamily: 'var(--font-figtree)', fontWeight: 400 }}>
            ...
            <div className="grid grid-cols-2 gap-7 mt-[11px]">
              {/* Back Office Feature */}
          ...
          <div className="relative pr-12 flex justify-end">
            <div className="relative">
              {/* Main Application UI Screenshot Placeholder - 84% of original (70% + 20% = 84%) */}
              <div className="w-[500px] h-[336px] bg-gray-200 rounded-2xl flex items-center justify-center">
                <p className="text-gray-500 font-medium">Main UI Screenshot</p>
              </div>

              {/* Revenue Widget - Bottom Right overlapping, half off edge of main UI but respecting page padding */}
              <div className="absolute bottom-0 -right-20 h-[150px] w-[250px] bg-white border-2 border-gray-300 rounded-xl flex items-center justify-center shadow-lg">
      ...
      <div className="rounded-4xl p-12 bg-white mt-10">
        <div className="grid grid-cols-2 gap-[67px] items-center">
          ...
          <div className="relative pl-12 flex justify-start">
            <div className="relative">
              ...
              {/* Mobile Placeholder - Behind revenue, above main UI, ends at right edge of revenue */}
              <div className="absolute top-8 -left-16 h-[280px] w-[160px] bg-white border-2 border-gray-300 rounded-2xl flex items-center justify-center shadow-lg z-0">
                <p className="text-gray-500 text-xs font-medium">Mobile</p>
              </div>

              {/* Revenue Widget - Bottom Right overlapping */}
              <div className="absolute bottom-0 -left-20 h-[150px] w-[250px] bg-white border-2 border-gray-300 rounded-xl flex items-center justify-center shadow-lg z-10">
                <p className="text-gray-500 text-sm font-medium">Revenue</p>
              </div>
            </div>
          </div>
