...
const showroomServices: ServiceItem[] = [
  {
    ...
    buttonText: 'Launch Your Gallery',
    buttonHref: '/contact?service=portfolio-gallery',
  ...
  },
  {
    ...
    buttonText: 'Get Material Library',
    buttonHref: '/contact?service=material-library',
  ...
  },
  {
    ...
    buttonText: 'Get AR Technology',
    buttonHref: '/contact?service=ar-visualization',
    imageSrc: 'https://images.unsplash.com/photo-1617802690658-1173a812650d?q=80&w=2670&auto=format&fit=crop',
