...
const aiDesignerServices: ServiceItem[] = [
  {
    ...
    buttonText: 'Get AI Designer',
    buttonHref: '/contact?service=room-redesign',
  ...
  },
  {
    ...
    buttonText: 'Get Style Explorer',
    buttonHref: '/contact?service=style-explorer',
  ...
  },
  {
    ...
    buttonText: 'Get Kitchen/Bath AI',
    buttonHref: '/contact?service=kitchen-bath-ai',
    imageSrc: 'https://images.unsplash.com/photo-1556912172-45b7abe8b7e1?q=80&w=2670&auto=format&fit=crop',
